...
/**
 * File for HSSF testing/examples WORKS ONLY WITH XLS FILE NOT XLSX
 *
...
public final class HSSFReadWriteExample {

	private HSSFReadWriteExample() {}
     ...
     * see {@link HSSFReadWriteExample#testCreateSampleSheet(String)}.<br>
     *
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 1) {
			...
			try (HSSFWorkbook wb = HSSFReadWriteExample.readFile(fileName)) {
			...
			if ("write".equalsIgnoreCase(args[1])) {
				...
				HSSFReadWriteExample.testCreateSampleSheet(fileName);
